...
class ParserProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        val symbols = resolver.getSymbolsWithAnnotation("org.tanukis.tanuki.parsers.MangaSourceParser")
        ...
        val factoryFile =
            try {
                codeGenerator.createNewFile(
                    ...
                    packageName = "org.tanukis.tanuki.parsers",
        ...
        val sourcesFile =
            try {
                codeGenerator.createNewFile(
                    dependencies = dependencies,
                    packageName = "org.tanukis.tanuki.parsers.model",
    ...
    private fun writeContent(
        ...
        factoryWriter?.write(
			...
			import org.tanukis.tanuki.parsers.core.MangaParserWrapper
